...
gxv_lcar_partial_validate( FT_Short partial,
  ...
  gxv_ctlPoint_validate( glyph, ( FT_UShort )
  partial, gxvalid );
...
static void
  gxv_lcar_LookupValue_validate( FT_UShort
...
static GXV_LookupValueDesc
  gxv_lcar_LookupFmt4_transit( FT_UShort
...
lookupval_func = gxv_lcar_LookupValue_validate;

gxvalid->

lookupfmt4_trans = gxv_lcar_LookupFmt4_transit;
