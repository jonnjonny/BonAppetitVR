...
static void
  gxv_prop_zero_advance_validate( FT_UShort
...
static void
  gxv_prop_property_validate( FT_UShort
...
static void
  gxv_prop_LookupValue_validate( FT_UShort
...
gxvalid )
{
gxv_prop_property_validate( value_p
...
static GXV_LookupValueDesc
  gxv_prop_LookupFmt4_transit( FT_UShort
...
gxv_prop_property_validate( defaultProp,
...
lookupval_func = gxv_prop_LookupValue_validate;

gxvalid->

lookupfmt4_trans = gxv_prop_LookupFmt4_transit;
