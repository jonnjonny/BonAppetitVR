...
gxv_array_getlimits_byte( FT_Bytes
...
subtable_length = ( FT_ULong )( p - table );
}
...
gxv_array_getlimits_ushort( FT_Bytes
...
gxv_BinSrchHeader_validate( FT_Bytes
...
searchRange = FT_NEXT_USHORT( p );

binSrchHeader.

entrySelector = FT_NEXT_USHORT( p );

binSrchHeader.

rangeShift = FT_NEXT_USHORT( p );
...
static GXV_LookupValueDesc
  gxv_lookup_value_load( FT_Bytes
...
static void
  gxv_LookupTable_fmt0_validate( FT_Bytes
...
lookupval_func( i, &value, gxvalid
 ...
 */
static void
  gxv_LookupTable_fmt2_skip_endmarkers( FT_Bytes
...
static void
  gxv_LookupTable_fmt2_validate( FT_Bytes
...
lookupval_func( gid, &value, gxvalid
...
static void
  gxv_LookupTable_fmt4_validate( FT_Bytes
...
static void
  gxv_LookupTable_fmt6_skip_endmarkers( FT_Bytes
...
static void
  gxv_LookupTable_fmt6_validate( FT_Bytes
...
gxv_glyphid_validate( glyph, gxvalid
...
lookupval_func( glyph, &value, gxvalid
...
static void
  gxv_LookupTable_fmt8_validate( FT_Bytes
...
lookupval_func( (FT_UShort)( firstGlyph + i ), &value, gxvalid
...
gxv_LookupTable_validate( FT_Bytes
...
gxv_glyphid_validate( FT_UShort
...
gxv_ctlPoint_validate( FT_UShort
...
gxv_sfntName_validate( FT_UShort
...
FT_Get_Sfnt_Name( gxvalid

->face, i, &name ) != FT_Err_Ok )
continue;
...
static void
  gxv_ClassTable_validate( FT_Bytes
...
static void
  gxv_StateArray_validate( FT_Bytes
...
static void
  gxv_EntryTable_validate( FT_Bytes
...
gxv_StateTable_subtable_setup( FT_UShort
...
gxv_set_length_by_ushort_offset( o, l, buff,

3, table_size, gxvalid );
}
...
gxv_StateTable_validate( FT_Bytes
...
optdata_load_func( p, limit, gxvalid
...
gxv_XStateTable_subtable_setup( FT_ULong
...
gxv_set_length_by_ulong_offset( o, l, buff,
...
static void
  gxv_XClassTable_lookupval_validate( FT_UShort
...
*/
static GXV_LookupValueDesc
  gxv_XClassTable_lookupfmt4_transit( FT_UShort
...
static void
  gxv_XStateArray_validate( FT_Bytes
...
static void
  gxv_XEntryTable_validate( FT_Bytes
...
gxv_XStateTable_validate( FT_Bytes
...
lookupval_sign = GXV_LOOKUPVALUE_UNSIGNED;

gxvalid->

lookupval_func = gxv_XClassTable_lookupval_validate;

gxvalid->

lookupfmt4_trans = gxv_XClassTable_lookupfmt4_transit;

gxv_LookupTable_validate( table
...
gxv_XStateArray_validate( table
...
gxv_XEntryTable_validate( table
...
gxv_odtect_validate( GXV_odtect_Range
