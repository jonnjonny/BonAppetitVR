...
static void
  gxv_morx_subtable_type1_substitutionTable_load( FT_Bytes
...
substitutionTable = FT_NEXT_USHORT( p );
}


static void
  gxv_morx_subtable_type1_subtable_setup( FT_ULong
...
static void
  gxv_morx_subtable_type1_LookupValue_validate( FT_UShort
 ...
 **/
static void
  gxv_morx_subtable_type1_substitutionTable_validate( FT_Bytes
...
lookupfmt4_trans = gxv_morx_subtable_type1_LookupFmt4_transit;
...
substitutionTable_num_lookupTables = 0;
