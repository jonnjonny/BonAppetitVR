...
static void
  gxv_bsln_LookupValue_validate( FT_UShort
...
static GXV_LookupValueDesc
  gxv_bsln_LookupFmt4_transit( FT_UShort
...
static void
  gxv_bsln_parts_fmt0_validate( FT_Bytes
...
table_data = NULL;      /* No ctlPoints here. */
...
static void
  gxv_bsln_parts_fmt1_validate( FT_Bytes
...
lookupval_func = gxv_bsln_LookupValue_validate;

gxvalid->

lookupfmt4_trans = gxv_bsln_LookupFmt4_transit;

gxv_LookupTable_validate( p
...
static void
  gxv_bsln_parts_fmt2_validate( FT_Bytes
...
static void
  gxv_bsln_parts_fmt3_validate( FT_Bytes
