...
static void
  gxv_morx_subtable_type2_opttable_load( FT_Bytes
...
ligActionTable = FT_NEXT_ULONG( p );

optdata->

componentTable = FT_NEXT_ULONG( p );

optdata->

ligatureTable = FT_NEXT_ULONG( p );
...
static void
  gxv_morx_subtable_type2_subtable_setup( FT_ULong
...
static void
  gxv_morx_subtable_type2_ligatureTable_validate( FT_Bytes
...
gxv_morx_subtable_type2_validate( FT_Bytes
