...
static void
  gxv_mort_subtable_type2_opttable_load( FT_Bytes
...
ligActionTable = FT_NEXT_USHORT( p );

optdata->

componentTable = FT_NEXT_USHORT( p );

optdata->

ligatureTable = FT_NEXT_USHORT( p );
...
static void
  gxv_mort_subtable_type2_subtable_setup( FT_UShort
...
static void
  gxv_mort_subtable_type2_ligatureTable_validate( FT_Bytes
...
gxv_mort_subtable_type2_validate( FT_Bytes
