...
static void
  gxv_morx_subtable_type5_insertionGlyphList_load( FT_Bytes
...
insertionGlyphList = FT_NEXT_ULONG( p );
}


static void
  gxv_morx_subtable_type5_subtable_setup( FT_ULong
...
static void
  gxv_morx_subtable_type5_InsertList_validate( FT_UShort
...
gxv_morx_subtable_type5_validate( FT_Bytes
