...
static void
  gxv_opbd_LookupValue_validate( FT_UShort
...
GXV_OPBD_DATA( valueOffset_min ) = value_p->
...
static GXV_LookupValueDesc
  gxv_opbd_LookupFmt4_transit( FT_UShort
...
lookupfmt4_trans = gxv_opbd_LookupFmt4_transit;
