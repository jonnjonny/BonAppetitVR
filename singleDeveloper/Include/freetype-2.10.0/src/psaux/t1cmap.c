...
t1_cmap_std_char_index( T1_CMapStd
...
t1_cmap_std_char_next( T1_CMapStd
...
t1_cmap_standard_init( T1_CMapStd
...
t1_cmap_expert_init( T1_CMapStd
...
t1_cmap_custom_init( T1_CMapCustom
...
encoding->code_last - cmap->

first;

cmap->

indices = encoding->char_index;
...
t1_cmap_custom_done( T1_CMapCustom
...
t1_cmap_custom_char_index( T1_CMapCustom
...
t1_cmap_custom_char_next( T1_CMapCustom
...
t1_cmap_unicode_done( PS_Unicodes
...
t1_cmap_unicode_char_index( PS_Unicodes
...
unicodes_char_index( unicodes, char_code
...
t1_cmap_unicode_char_next( PS_Unicodes
...
unicodes_char_next( unicodes, pchar_code
