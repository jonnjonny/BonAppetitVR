...
cf2_arrstack_init( CF2_ArrStack
...
cf2_arrstack_finalize( CF2_ArrStack
...
cf2_arrstack_setNumElements( CF2_ArrStack arrstack,
  ...
  {
    FT_Error
    error = FT_Err_Ok;        /* for FT_REALLOC */
    FT_Memory memory = arrstack->memory; /* for FT_REALLOC */

    size_t
    newSize = numElements * arrstack->sizeItem;
...
cf2_arrstack_setCount( CF2_ArrStack
...
cf2_arrstack_setNumElements( arrstack, numElements
...
cf2_arrstack_clear( CF2_ArrStack
...
cf2_arrstack_push( CF2_ArrStack
...
FT_MEM_COPY( newPtr, ptr, arrstack
