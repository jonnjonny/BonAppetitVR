...
t1_lookup_glyph_by_stdcharcode_ps( PS_Decoder
...
t1_decoder_parse_metrics( T1_Decoder
...
parse_state = T1_Parse_Have_Width;

builder->left_bearing.

x = ADD_LONG( builder->left_bearing.x,
              top[0] );
...
y = ADD_LONG( builder->left_bearing.y,
              top[1] );
