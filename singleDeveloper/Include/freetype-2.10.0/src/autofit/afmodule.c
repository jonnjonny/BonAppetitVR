...
static FT_Error
  af_property_get_face_globals( FT_Face
...
af_property_set( FT_Module ft_module,
  ...
  if( !ft_strcmp( property_name, "fallback-script" ) ) {
    ...
    for( ss = 0; af_style_classes[ss]; ss++ ) {
      AF_StyleClass
      style_class = af_style_classes[ss];


      if( ( FT_UInt )
        style_class->script == *fallback_script &&
...
#endif
    {
      FT_Bool * no_stem_darkening = ( FT_Bool * )
      value;
...
af_property_get( FT_Module ft_module,
  ...
  module = ( AF_Module ) ft_module;
  FT_UInt
  fallback_style = module->fallback_style;
  FT_UInt
  default_script = module->default_script;
#ifdef AF_CONFIG_OPTION_USE_WARPER
  ...
  if( !ft_strcmp( property_name, "glyph-to-script-map" ) ) {
    ...
    *val = default_script;
    ...
    FT_Bool
    no_stem_darkening = module->no_stem_darkening;
    FT_Bool * val = ( FT_Bool * )
    value;
...
ft_service_list_lookup( af_services, module_interface
...
module->darken_params[0]  =

CFF_CONFIG_OPTION_DARKENING_PARAMETER_X1;

module->darken_params[1]  =

CFF_CONFIG_OPTION_DARKENING_PARAMETER_Y1;

module->darken_params[2]  =

CFF_CONFIG_OPTION_DARKENING_PARAMETER_X2;

module->darken_params[3]  =
...
af_autofitter_load_glyph( AF_Module
