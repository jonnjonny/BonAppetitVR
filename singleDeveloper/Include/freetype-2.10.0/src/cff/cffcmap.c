...
cff_cmap_encoding_init( CFF_CMapStd
...
cff_cmap_encoding_done( CFF_CMapStd
...
cff_cmap_encoding_char_index( CFF_CMapStd
...
cff_cmap_encoding_char_next( CFF_CMapStd
...
cff_index_get_sid_string( cff, sid
...
cff_cmap_unicode_init( PS_Unicodes
...
cff_cmap_unicode_done( PS_Unicodes
...
cff_cmap_unicode_char_index( PS_Unicodes
...
cff_cmap_unicode_char_next( PS_Unicodes
