...
ftc_basic_family_compare( FTC_MruNode
...
ftc_basic_family_init( FTC_MruNode
...
ftc_basic_family_get_count( FTC_Family
...
ftc_basic_family_load_bitmap( FTC_Family
...
ftc_basic_family_load_glyph( FTC_Family
...
ftc_basic_gnode_compare_faceid( FTC_Node
...
FTC_GCache_New( manager, &ftc_basic_image_cache_class,
(FTC_GCache
...
FTC_GCache_New( manager, &ftc_basic_sbit_cache_class,
(FTC_GCache
