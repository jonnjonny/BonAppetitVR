...
face_id = query->face_id;

node->

cmap_index = query->cmap_index;

node->

first = ( query->char_code / FTC_CMAP_INDICES_MAX ) *
...
ftc_cmap_node_compare( FTC_Node
...
FT_BOOL( offset < FTC_CMAP_INDICES_MAX );
}
...
ftc_cmap_node_remove_faceid( FTC_Node
...
FTC_Manager_RegisterCache( manager,
...
hash = FTC_CMAP_HASH( face_id, ( FT_UInt )
  cmap_index, char_code );
