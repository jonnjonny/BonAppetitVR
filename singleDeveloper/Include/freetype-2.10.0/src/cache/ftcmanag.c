...
static FT_Error
  ftc_scaler_lookup_size( FTC_Manager
...
ftc_size_node_done( FTC_MruNode
...
ftc_size_node_compare( FTC_MruNode
...
ftc_size_node_init( FTC_MruNode
...
ftc_scaler_lookup_size( manager, scaler, &node
...
ftc_size_node_reset( FTC_MruNode
...
ftc_face_node_init( FTC_MruNode
...
ftc_face_node_done( FTC_MruNode
...
FTC_MruList_RemoveSelection( &manager
...
ftc_face_node_compare( FTC_MruNode
...
request_face = requester;

manager->

request_data = req_data;

FTC_MruList_Init( &manager
...
FTC_Manager_FlushN( manager, manager
...
FTC_Manager_Compress( FTC_Manager
...
FTC_Manager_RegisterCache( FTC_Manager
...
manager->caches[manager->num_caches++] =
...
FTC_Manager_FlushN( FTC_Manager
...
FTC_Manager_RemoveFaceID( FTC_Manager
...
FTC_Cache_RemoveFaceID( manager
