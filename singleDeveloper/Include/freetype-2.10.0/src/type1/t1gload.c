...
T1_Compute_Max_Advance( T1_Face
...
subrs_len = type1->subrs_len;

decoder.

subrs_hash = type1->subrs_hash;

decoder.

buildchar = face->buildchar;

decoder.

len_buildchar = face->len_buildchar;
...
T1_Parse_Glyph( &decoder, (FT_UInt)
...
T1_Load_Glyph( FT_GlyphSlot

t1glyph,          /* T1_GlyphSlot */
...
vertAdvance = ( face->type1.font_bbox.yMax -
...
control_data = ( FT_Byte* ) glyph_data.pointer;

t1glyph->

control_len = glyph_data.length;
}
