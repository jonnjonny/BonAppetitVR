...
{
FT_STRCPYN( buffer, face

->type1.glyph_names[glyph_index], buffer_max );
...
static const char*
  t1_get_ps_name( T1_Face

face )
{
return (const char*) face->type1.
...
static FT_Error
  t1_ps_get_font_private( FT_Face
...
>= retval )
*((FT_Int *)value) = type1->private_dict.
...
(void *)( type1->glyph_names[idx] ), retval );
...
if( type1->encoding_type ==

T1_ENCODING_TYPE_ARRAY &&
  idx <( FT_UInt )

type1->encoding.num_chars       )
{
...
(void *)( type1->encoding.char_name[idx] ),
retval - 1 );
((FT_Char *)value)[retval - 1] = (FT_Char)'\0';
}
}
...
size_t* val = ft_hash_num_lookup( ( FT_Int )
...
>= retval )
*((FT_Byte *)value) = type1->private_dict.
...
>= retval )
*((FT_Fixed *)value) = type1->private_dict.
...
>= retval )
*((FT_Bool *)value) = type1->private_dict.
...
>= retval )
*((FT_Long *)value) = type1->private_dict.
...
>= retval )
*((FT_Short *)value) = type1->font_info.
...
>= retval )
*((FT_UShort *)value) = type1->font_info.
...
>= retval )
*((FT_UShort *)value) = type1->font_extra.
...
(void *)( type1->font_info.version ), retval );
}
break;
...
(void *)( type1->font_info.notice ), retval );
}
break;
...
(void *)( type1->font_info.full_name ), retval );
}
break;
...
(void *)( type1->font_info.family_name ),
retval );
}
break;
...
(void *)( type1->font_info.weight ), retval );
}
break;
...
ft_service_list_lookup( t1_services, t1_interface
