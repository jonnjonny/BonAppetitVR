...
FT_THROW( Missing_Property );
}


static FT_Error
  tt_property_get( FT_Module
...
metrics = ( load_flags & FT_LOAD_NO_HINTING )
          ? &ttsize->metrics
          : &size->hinted_metrics;
...
get_interface( driver, tt_interface
