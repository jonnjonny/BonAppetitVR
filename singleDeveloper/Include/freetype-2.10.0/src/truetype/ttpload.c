...
FT_FRAME_EXTRACT( table_len, face
...
FT_FRAME_EXTRACT( table_size, face
...
hdmx_record_count = nn;

face->

hdmx_table_size = table_size;

face->

hdmx_record_size = record_size;
...
tt_face_get_device_metrics( TT_Face
