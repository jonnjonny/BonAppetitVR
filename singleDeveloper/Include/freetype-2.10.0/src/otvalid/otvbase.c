...
static void
  otv_BaseCoord_validate( FT_Bytes
...
static void
  otv_BaseTagList_validate( FT_Bytes
...
static void
  otv_BaseValues_validate( FT_Bytes
...
static void
  otv_BaseScript_validate( FT_Bytes
...
otv_MinMax_validate( table

+ DefaultMinMax, otvalid );
...
static void
  otv_BaseScriptList_validate( FT_Bytes
...
otv_BaseTagList_validate( table

+ BaseTagList, otvalid );

/* BaseScriptList */
otv_BaseScriptList_validate( table
