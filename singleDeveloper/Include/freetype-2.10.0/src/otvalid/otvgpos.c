...
static void
  otv_MarkArray_validate( FT_Bytes
...
otv_Anchor_validate( table

+ anchor_offset, otvalid );
}
else
...
static void
  otv_ValueRecord_validate( FT_Bytes
...
otv_Device_validate( otvalid

->extra3 + device, otvalid );
}
format >>= 1;
}
...
otv_Device_validate( table

+ XDeviceTable, otvalid );
...
static void
  otv_SinglePos_validate( FT_Bytes
...
static void
  otv_CursivePos_validate( FT_Bytes
...
static void
  otv_MarkBasePos_validate( FT_Bytes
...
static void
  otv_MarkLigPos_validate( FT_Bytes
...
static void
  otv_MarkMarkPos_validate( FT_Bytes
...
static void
  otv_ContextPos_validate( FT_Bytes
...
static void
  otv_ChainContextPos_validate( FT_Bytes
...
static void
  otv_ExtensionPos_validate( FT_Bytes
...
otv_GPOS_subtable_validate( FT_Bytes
...
otv_LookupList_validate( table

+ LookupList,
otvalid );

otv_FeatureList_validate( table

+ FeatureList, table + LookupList,
otvalid );

otv_ScriptList_validate( table

+ ScriptList, table + FeatureList,
otvalid );
