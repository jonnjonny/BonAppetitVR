...
static void
  otv_SingleSubst_validate( FT_Bytes
...
otv_Coverage_validate( Coverage, otvalid,
...
static void
  otv_MultipleSubst_validate( FT_Bytes
...
static void
  otv_AlternateSubst_validate( FT_Bytes
...
static void
  otv_Ligature_validate( FT_Bytes
...
static void
  otv_LigatureSubst_validate( FT_Bytes
...
static void
  otv_ContextSubst_validate( FT_Bytes
...
static void
  otv_ChainContextSubst_validate( FT_Bytes
...
static void
  otv_ExtensionSubst_validate( FT_Bytes
...
static void
  otv_ReverseChainSingleSubst_validate( FT_Bytes
