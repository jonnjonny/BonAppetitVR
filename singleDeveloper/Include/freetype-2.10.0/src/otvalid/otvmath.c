...
static void
  otv_MathConstants_validate( FT_Bytes
...
static void
  otv_MathItalicsCorrectionInfo_validate( FT_Bytes
...
static void
  otv_MathKern_validate( FT_Bytes
...
static void
  otv_MathKernInfo_validate( FT_Bytes
...
otv_MathKern_validate( table

+ MKRecordOffset, otvalid );
}
}
...
static void
  otv_MathGlyphInfo_validate( FT_Bytes
...
+ MathItalicsCorrectionInfo, otvalid, TRUE );
...
+ MathTopAccentAttachment, otvalid, FALSE );
...
+ ExtendedShapeCoverage, otvalid, -1 );
OTV_EXIT;
}

if( MathKernInfo )

otv_MathKernInfo_validate( table

+ MathKernInfo, otvalid );
...
static void
  otv_GlyphAssembly_validate( FT_Bytes
...
static void
  otv_MathGlyphConstruction_validate( FT_Bytes
...
otv_GlyphAssembly_validate( table

+GlyphAssembly, otvalid );
...
static void
  otv_MathVariants_validate( FT_Bytes
...
otv_MathGlyphConstruction_validate( table
...
otv_MathConstants_validate( table

+ MathConstants,
otvalid );

otv_MathGlyphInfo_validate( table

+ MathGlyphInfo,
otvalid );

otv_MathVariants_validate ( table
