...
static void
  otv_CaretValue_validate( FT_Bytes
...
static void
  otv_MarkGlyphSets_validate( FT_Bytes
...
otv_MarkGlyphSets_validate( table

+ MarkGlyphSetsDef, otvalid );
}
