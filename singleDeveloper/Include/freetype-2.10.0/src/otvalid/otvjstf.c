...
static void
  otv_JstfPriority_validate( FT_Bytes
...
+ ShrinkageDisableGSUB, otvalid );

otvalid->

extra1 = gpos_lookup_count;
...
static void
  otv_JstfScript_validate( FT_Bytes
...
extra1 = otv_GSUBGPOS_get_Lookup_count( gsub );
...
extra2 = otv_GSUBGPOS_get_Lookup_count( gpos );
