...
FT_Raccess_Get_HeaderInfo( FT_Library
...
rdata_len <*rdata_pos ||
           ...
           ( FT_ULong )( rfork_offset + *rdata_pos + rdata_len )> stream
...
FT_Raccess_Get_DataOffsets( FT_Library
...
FT_NEW_ARRAY( offsets_internal, * count
...
j++ )
offsets_internal[j] = rdata_pos + ref[j].
