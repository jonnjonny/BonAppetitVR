...
FT_MAX( FT_MAX( sub[0].x, sub[1].x ), sub[2]

.x );
cbox->xMax -=

FT_MIN( FT_MIN( sub[0].x, sub[1].x ), sub[2]

.x );
cbox->yMin -=

FT_MAX( FT_MAX( sub[0].y, sub[1].y ), sub[2]

.y );
cbox->yMax -=

FT_MIN( FT_MIN( sub[0].y, sub[1].y ), sub[2]
...
FT_Library_SetLcdGeometry( FT_Library
...
->lcd_geometry, sub, 3 * sizeof( FT_Vector ) );
