...
FT_Set_MM_WeightVector( FT_Face
...
FT_Get_MM_WeightVector( FT_Face
...
ft_face_get_mvar_service( face, &service_mvar

);

if(

service_mvar &&service_mvar
...
FT_Get_Var_Design_Coordinates( FT_Face
...
FT_Get_MM_Blend_Coordinates( FT_Face
...
FT_Get_Var_Blend_Coordinates( FT_Face
...
FT_Get_Var_Axis_Flags( FT_MM_Var
