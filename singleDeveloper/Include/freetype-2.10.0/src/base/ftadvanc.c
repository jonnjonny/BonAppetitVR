...
func &&LOAD_ADVANCE_FAST_CHECK( face, flags ) )
{
FT_Error error;
...
_ft_face_scale_advances( face, padvance,
...
_ft_face_scale_advances( face, padvances, count, flags
...
flags &FT_ADVANCE_FLAG_FAST_ONLY
