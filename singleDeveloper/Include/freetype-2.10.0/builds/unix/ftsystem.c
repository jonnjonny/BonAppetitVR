...
ft_close_stream_by_munmap( FT_Stream
...
ft_close_stream_by_free( FT_Stream
...
close = ft_close_stream_by_munmap;
...
base = ( unsigned char* ) ft_alloc( NULL, stream->size );
