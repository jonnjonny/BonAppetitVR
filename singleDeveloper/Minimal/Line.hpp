...
public:
	...
	void draw(GLuint shaderProgram, const glm::mat4 &projection, const glm::mat4 &view, glm::vec3 pta, glm::vec3 ptb) {
		...
		*/
		...
		glBindVertexArray(VAO);
		// Tell OpenGL to draw with line
		glDrawArrays(GL_LINE, 0, 2 ); // 2 vertices per line,
